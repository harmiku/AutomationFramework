...
public class ExcelReader {
	...
	public static void main(String arg[]) throws IOException {
		...
		for (int row = 1; row <= datatable.getRowCount("TestResults"); row++) {
			for (int col = 0; col < datatable.getColumnCount("TestResults"); col++) {
				System.out.print(String.format("%28s",datatable.getCellData("TestResults", col, row)));
			}
			System.out.println();
		}
	}
