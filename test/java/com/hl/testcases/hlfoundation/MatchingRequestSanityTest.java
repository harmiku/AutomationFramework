...
public class MatchingRequestSanityTest extends TestBase {

	public LandingPage landingPage;
	public NewMatchingRequestPage newMatchingRequestPage;
	...
	void setupClass() {
		...
		newMatchingRequestPage=new NewMatchingRequestPage(driver);
	...
	@Parameters("runMode")
	public void Add_New_Matching_Request(String runMode) {
		if(!runMode.equals("Scenario1")) throw new SkipException("Skipping this exception");
		setDefaultUser();
		executeSQLDeleteStaffAllMatchingRequests();
		landingPage.clickCreateMatchingRequest();
		newMatchingRequestPage.createNewMatchingRequest("MatchingRequest1","");
		String progressMessage=" $0 matched out of $1000 allowed for 2023 ";
		By byProgressMessage = By.xpath("//*[text()='"+progressMessage+"']");
		newMatchingRequestPage.isValidationMessageVisible(byProgressMessage, progressMessage, "PendingInitialApproval",-300);
		newMatchingRequestPage.isPendingRequestMessageVisible("PendingInitialApproval");
	}
	
	@Test(priority = 3, enabled = true)
	public void Verify_SubmittedRequest_After_Adding_NewRequest() {
		landingPage.clickSubmittedRequests();
		submittedRequestsPage.clickMatchingButton();
		submittedRequestsPage.verifyData("MatchingRequest1", "Pending");
	}

	@Test(priority = 5, enabled = true)
	public void Update_PendingInitialApproval_Request() {
		landingPage.clickSubmittedRequests();
		submittedRequestsPage.clickMatchingButton();
		submittedRequestsPage.clickUpdateButton();
		updateMatchingRequestPage.verifyData("MatchingRequest1");
		updateMatchingRequestPage.updateMatchingRequest("MatchingRequest2","");
	}
	
	@Test(priority = 7, enabled = true)
	public void Verify_SubmittedRequest_After_Updating_PendingInitialApproval() {
		landingPage.clickSubmittedRequests();
		submittedRequestsPage.clickMatchingButton();
		submittedRequestsPage.verifyData("MatchingRequest2", "Pending");
	}

	@Test(priority = 9, enabled = true)
	public void Update_NeedsInfo_Request() {
		executeSQLUpdateAllMatchingRequestsStatus("11");
		refreshPage();
		landingPage.clickSubmittedRequests();
		submittedRequestsPage.clickMatchingButton();
		submittedRequestsPage.clickUpdateButton();
		updateMatchingRequestPage.verifyData("MatchingRequest2");
		updateMatchingRequestPage.updateMatchingRequest("MatchingRequest1","");
	}
	
	@Test(priority = 11, enabled = true)
	public void Verify_SubmittedRequest_After_Updating_NeedsInfo() {
		landingPage.clickSubmittedRequests();
		submittedRequestsPage.clickMatchingButton();
		submittedRequestsPage.verifyData("MatchingRequest1", "Needs Information");
	}

	@Test(priority = 13, enabled = true)
	public void Verify_Approver1_Can_Approve() {
		executeSQLUpdateAllMatchingRequestsStatus("9");
		assignApprover1();
		...
		approvalQueuePage.setTextArea("Approver1 Approved");
		approvalQueuePage.clickSubmitButton();
		updateMatchingRequestPage.isRecordUpdatedSuccessfullyVisible();
		
	}

	@Test(priority = 15, enabled = true)
	public void Verify_Approver1_Can_Reject() {
		executeSQLUpdateAllMatchingRequestsStatus("9");
		landingPage.clickApprovalQueue();
		approvalQueuePage.setGlobalFilter(executeSQLSelectName());
		approvalQueuePage.clickReviewButton();
		approvalQueuePage.selectAction("Rejected");
		approvalQueuePage.setTextArea("Approver1 Rejected");
		approvalQueuePage.clickSubmitButton();
		updateMatchingRequestPage.isRecordUpdatedSuccessfullyVisible();
	...
	public void Verify_Approver1_Can_NeedsInfo() {
		executeSQLUpdateAllMatchingRequestsStatus("9");
		landingPage.clickApprovalQueue();
		approvalQueuePage.setGlobalFilter(executeSQLSelectName());
		approvalQueuePage.clickReviewButton();
		approvalQueuePage.selectAction("Need Info");
		approvalQueuePage.setTextArea("Approver1 Need Info");
		approvalQueuePage.clickSubmitButton();
		updateMatchingRequestPage.isRecordUpdatedSuccessfullyVisible();
	...
	public void Verify_Approver2_Can_Approve() {
		...
		approvalQueuePage.clickReviewButton();
		approvalQueuePage.selectAction("Approved");
		approvalQueuePage.setTextArea("Approver2 Approved");
		approvalQueuePage.clickSubmitButton();
		updateMatchingRequestPage.isRecordUpdatedSuccessfullyVisible();
	}

	@Test(priority = 21, enabled = true)
	public void Verify_Approver2_Can_Reject() {
		executeSQLUpdateAllMatchingRequestsStatus("10");
		landingPage.clickApprovalQueue();
		approvalQueuePage.setGlobalFilter(executeSQLSelectName());
		approvalQueuePage.clickReviewButton();
	...
	public void Verify_Approver2_Can_NeedsInfo() {
		executeSQLUpdateAllMatchingRequestsStatus("10");
		landingPage.clickApprovalQueue();
		approvalQueuePage.setGlobalFilter(executeSQLSelectName());
		approvalQueuePage.clickReviewButton();
		approvalQueuePage.selectAction("Need Info");
		approvalQueuePage.setTextArea("Approver2 Need Info");
		approvalQueuePage.clickSubmitButton();
		updateMatchingRequestPage.isRecordUpdatedSuccessfullyVisible();
	}
	...
	@Test(priority = 2, enabled = true, groups = {"frontend"})
	public void ValidateOfficeLocation() {
		refreshPage();
		newMatchingRequest.ValidateOfficeLocation();
	}

	@Test(priority = 3, enabled = true, groups = {"frontend"})
	...
	public void Validate_HaveYouDonatedToThisCharityBefore_No() {
		executeSQLDeleteStaffAllMatchingRequests();
		landingPage.clickCreateMatchingRequest();
		newMatchingRequest.createNewMatchingRequest("100");
		executeSQLUpdateAllMatchingRequestsStatus("12");
		refreshPage();
		newMatchingRequest.setPreviousCharityRadioPositive();
		newMatchingRequest.setCharityDropDown("RedCross", ExceptionHandling.FAIL);
	...
	public void Validate_HaveYouDonatedToThisCharityBefore_Yes() {
		...
		newMatchingRequest.enterCharityInfo();
	...
	public void Verify_PendingRequestMessage_Displayed_ForPendingDocumentSubmission_Request() {
		executeSQLUpdateStaff("FIN","4 Sr Vice President","2022-03-14 00:00:00.000");
		executeSQLDeleteStaffAllMatchingRequests();
		landingPage.clickCreateMatchingRequest();
		newMatchingRequest.createNewMatchingRequest("100");
		...
		refreshPage();
		newMatchingRequest.isNotPendingRequestMessageVisible("PendingDocumentSubmission");
	}
	...
	public void Verify_MaxedOutReimbursementRate(String managementLevel, String managementLevelName, String amount) {
		...
		executeSQLDeleteStaffAllMatchingRequests();
		landingPage.clickCreateMatchingRequest();
		newMatchingRequest.createNewMatchingRequest(amount);
		executeSQLUpdateAllMatchingRequestsStatus("12");
		refreshPage();
	...
	@Test(priority = 55, enabled = true, groups = {"upload"})
	...
	@Test(priority = 56, enabled = true, groups = {"upload"})
	...
	@Test(priority = 57, enabled = true, groups = {"upload"})
	...
	@Test(priority = 62, enabled = true, dependsOnMethods = { "Verify_PendingInitialApproval_NotAddedToMatchedAmount" })
	...
	@Test(priority = 63, enabled = true, dependsOnMethods = { "Verify_PendingInitialApproval_NotAddedToMatchedAmount" })
	...
	@Test(priority = 64, enabled = true, dependsOnMethods = { "Verify_PendingInitialApproval_NotAddedToMatchedAmount" })
	...
	@Test(priority = 65, enabled = true, dependsOnMethods = { "Verify_PendingInitialApproval_NotAddedToMatchedAmount" })
	...
	@Test(priority = 66, enabled = true, dependsOnMethods = { "Verify_PendingInitialApproval_NotAddedToMatchedAmount" })
	...
	@Test(priority = 67, enabled = true, dependsOnMethods = { "Verify_Approved_AddedToMatchedAmount" })
	...
	public void Verify_createNewMatchingRequest() {
		...
		executeSQLDeleteStaffAllMatchingRequests();
		landingPage.clickCreateMatchingRequest();
		newMatchingRequest.createNewMatchingRequest("");
	}
